        ...
        >
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
            <div className="flex-1 min-w-0">
              <h1 className="bg-clip-text text-transparent bg-gradient-to-b from-neutral-50  to-neutral-800 font-bold tracking-tight sm:text-6xl leading-tight  glowing-text text-5xl md:text-6xl lg:text-6xl xl:text-6xl gap-3 break-words">
                Browse Reports
                {newReportsCount > 0 && (
                  <motion.div
                    initial={{ scale: 0 }}
