        ...
        if (response.ok) {
          ...
          if (messages.length > 0 && !silent) {
            const newMessages = data.filter(
              (msg: Message) =>
                !messages.find((existing) => existing._id === msg._id) &&
                !msg.read
            );
          ...
          <div className="text-center flex-1">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              {unreadCount > 0 && (
                <Badge
                  variant="destructive"
                  className="text-lg px-3 py-1 animate-pulse bg-red-600 text-white"
                >
                  {unreadCount} new
                </Badge>
              )}
            ...
            <p className="text-muted-foreground">
              Chat with people about found phones
            </p>
          </div>
          <Button
            variant="outline"
            ...
            {loading ? (
              <div className="space-y-4 max-w-4xl mx-auto">
                {Array.from({ length: 3 }).map((_, i) => (
                  <Card
                    key={i}
                    className="animate-pulse bg-card border-border/50"
                  >
                ...
                {filteredMessages.map((message) => (
                  <Card
                    ...
                    className={`transition-all hover:shadow-lg bg-card border-border/50 ${
                      !message.read
                        ? 'ring-2 ring-primary/20 bg-primary/5 shadow-md'
                        : ''
                    }`}
                  >
                    <CardContent className="p-6">
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <div>
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                {!message.read && (
                                  <Badge
                                    variant="destructive"
                                    className="text-xs animate-pulse bg-red-600 text-white"
                                  >
                                    NEW
                                  </Badge>
                                )}
                              ...
                              <div className="flex items-center gap-4 text-sm text-muted-foreground">
                                ...
                                {message.report && (
                                  <div className="flex items-center gap-1">
                                    ...
                                    {message.report.brand}{' '}
                                    {message.report.color}
                                  </div>
                                )}
                              </div>
                            </div>
                          ...
                          {message.subject && (
                            <div className="mb-3">
                              <h4 className="font-medium text-base text-primary text-black">
                                {message.subject}
                              </h4>
                            </div>
                          )}
                          ...
                          <div className="bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-900/20 dark:to-green-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4 mb-4">
                            ...
                            <div className="space-y-3">
                              ...
                              <p className="text-blue-700 dark:text-blue-300 text-sm text-center">
                                📞 Contact {message.from.name} directly to
                                coordinate the phone return
                              </p>
                            </div>
                          </div>
              ...
              <Card className="max-w-2xl mx-auto bg-card border-border/50">
                <CardContent className="py-16 text-center">
                  ...
                  <p className="text-muted-foreground text-lg max-w-md mx-auto">
                    You have no unread messages. Great job staying on top of
                    your communications!
                  </p>
                </CardContent>
              </Card>
            ...
            {messages.filter((m) => m.read).length > 0 ? (
              ...
              <Card className="max-w-2xl mx-auto bg-card border-border/50">
                <CardContent className="py-16 text-center">
                  ...
                  <p className="text-muted-foreground text-lg max-w-md mx-auto">
                    Messages you&apos;ve read will appear here for easy
                    reference.
                  </p>
                </CardContent>
              </Card>
