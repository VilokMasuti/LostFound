...
export function ModernReportForm({ defaultType, referenceId }: ModernReportFormProps) {
  ...
  const onSubmit = async (data: ReportFormData) => {
    ...
    try {
      ...
      if (watchType === "lost") {
        toast.success("✅ Your lost phone report is live! We'll notify you if we find a match.", {
          style: {
            background: "#111111",
            color: "#FFFFFF",
            border: "1px solid #333333",
        ...
        if (referencedReport) {
          toast.success("❤️ Found phone report submitted! The owner has been notified and will contact you.", {
            style: {
              background: "#111111",
              color: "#FFFFFF",
              border: "1px solid #333333",
          ...
          toast.success("❤️ Thanks for reporting! We'll contact the owner if we find a match.", {
            style: {
              background: "#111111",
              color: "#FFFFFF",
              border: "1px solid #333333",
      ...
      if (result.matches && result.matches > 0) {
        setTimeout(() => {
          toast.success(`🎯 Found ${result.matches} possible match${result.matches > 1 ? "es" : ""}!`, {
            style: {
              background: "#111111",
              color: "#FFFFFF",
              border: "1px solid #333333",
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {referencedReport && (
            <Alert className="mb-6 border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/20">
              ...
              <AlertDescription className="text-blue-800 dark:text-blue-200">
                <strong>📱 Matching Lost Phone Found!</strong> You&apos;re reporting a found phone that matches{" "}
                <strong>
                  {referencedReport.brand} {referencedReport.color}
                </strong>{" "}
                lost near <strong>{referencedReport.location}</strong>. The form has been pre-filled with matching
                details. The owner will be notified immediately when you submit.
              </AlertDescription>
            </Alert>
          )}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Provide as much detail as possible to help with matching. All fields marked with * are required.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit(onSubmit, handleFormError)} className="space-y-8">
                ...
                {!referencedReport && (
                  <>
                    <div className="space-y-4">
                      <Label className="text-base font-medium">What happened to the item? *</Label>
                      <RadioGroup
                        value={watchType}
                        ...
                        <div>
                          ...
                          >
                            <div className="flex items-center space-x-3 mb-3">
                              ...
                              >
                                <Search
                                  className={cn("h-6 w-6", watchType === "lost" ? "text-red-600" : "text-red-500")}
                                />
                              </div>
                              <span className="font-semibold text-lg">I Lost Something</span>
                            </div>
                        ...
                        <div>
                          ...
                          >
                            <div className="flex items-center space-x-3 mb-3">
                              ...
                              >
                                <Heart
                                  className={cn("h-6 w-6", watchType === "found" ? "text-green-600" : "text-green-500")}
                                />
                              </div>
                              <span className="font-semibold text-lg">I Found Something</span>
                            </div>
                            <span className="text-sm text-muted-foreground text-center">
                              Help return an item to its owner
                            </span>
                            {watchType === "found" && <Badge className="mt-2 text-primary-foreground">Selected</Badge>}
                          </Label>
                        </div>
                      </RadioGroup>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select onValueChange={(value) => setValue("brand", value)} value={watchBrand}>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select onValueChange={(value) => setValue("color", value)} value={watchColor}>
                            ...
                            <SelectItem key={color} value={color}>
                              <div className="flex items-center gap-2">
                                <div
                                  ...
                                  style={{
                                    backgroundColor: color.toLowerCase() === "other" ? "#gray" : color.toLowerCase(),
                                  }}
                                />
                                {color}
                              </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Include the specific model if known - this helps with matching
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Be as specific as possible - include landmarks, street names, or building names
                    </p>
                    {watchLocation && watchLocation.length < 5 && (
                      <p className="text-xs text-yellow-600">⚠️ Location should be more specific</p>
                    )}
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="dateLostFound" className="flex items-center gap-2">
                    ...
                    />
                    {errors.dateLostFound && <p className="text-sm text-destructive">{errors.dateLostFound.message}</p>}
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>The more details you provide, the easier it will be to match with the right owner</span>
                    <span className={watchDescription && watchDescription.length < 20 ? "text-yellow-600" : ""}>
                  ...
                  <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                    <div className="flex items-center gap-2 text-blue-800 dark:text-blue-200">
                      ...
                      <span className="text-sm font-medium">
                        Provide at least one contact method so people can reach you
                      </span>
                    </div>
                  </div>
                    ...
                    {imagePreview ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">
                            A clear photo greatly increases the chances of a successful match
                          </p>
                        </div>
                      </div>
                    )}
                ...
                <div className="space-y-4">
                  {watchBrand && watchColor && (
                    <div className="p-4 bg-muted rounded-lg">
                      <p className="text-sm">
                        <strong>Summary:</strong> You&apos;re reporting a {watchType} {watchBrand} {watchColor} phone
                        {referencedReport && " that matches a lost phone report"}
                      </p>
                    </div>
                  )}
                  ...
                  <p className="text-xs text-center text-muted-foreground">
                    By submitting this report, you agree to be contacted by users who may have found/lost your item.
                  </p>
                </div>
              </form>
            </CardContent>
