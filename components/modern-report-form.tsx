...
export function ModernReportForm({
  ...
  const onSubmit = async (data: ReportFormData) => {
    ...
    try {
      ...
      // Replace the current redirect with role-specific redirects
      if (watchType === 'lost') {
            ...
            <CardContent>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    The more details you provide, the easier it will be to match
                ...
                <div className="space-y-6">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Provide at least one way for people to contact you (optional
                    but recommended)
                  </p>
